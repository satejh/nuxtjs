<template>
  <div>
    <div class="py-4 rounded-md" v-for="(item, index) in items" :key="index">
      <section class="bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div class="container px-4 py-4">
          <div class="items-center lg:flex">
            ...
            <div class="lg:w-6/12 my-2 mt-1">
            
              <h2 class="text-xl subpixel-antialiased font-bold text-gray-800 dark:text-gray-100">
                {{ item.Title }}
              </h2>
              <div class="font-bold rounded py-2 text-green-600">
                {{ item.Date }}
              </div>
              <div class="pt-2" v-if="item.category">
                <a
                  href="#"
                  class="
                    px-2
              ...
              <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                <a
                  ...
                  href="#"
                  >@{{ item.users_permissions_user.username }}</a
                >
                , {{ item.Context }}
              </p>
              <div class="flex items-center mt-4 -mx-2">
                <div v-if="privatepost == 'True'">
                  <NuxtLink
                    class="
                      px-3
                      py-1.5
