...
export default {
  ...
  blogs2: blogs(limit: 3, sort: "date:desc"){
    id,
    published_at,
    Title,
    Context,
...
myy(){
  ...
  cert: fs.readFileSync("~/assestss/blogerpedia.pem"),
  key: fs.readFileSync("~/assestss/blogerpedia.key"),
  passphrase: "pass@123",
});
let prefetch =  this.axios({
      url: "graphql",
      method: "post",
    httpsAgent,
      data: {
...
`,
        ...
        this.items = prefetch.data.data.blogs1;
    this.latest = prefetch.data.data.blogs2;
},
