<template>
  <div class="pt-28 pb-12 bg-gray-100">
    <div
      class="
        flex
        max-w-sm
...
<div v-if="alertOpen" class="text-white my-6 px-6 py-6 border-0 rounded relative mb-4 bg-red-500" :class="`bg-`+color+`-500`">
    <span class="inline-block align-middle mr-8">
      <b class="capitalize">{{this.alert}}</b> {{this.error}}
    </span>
        ...
        <div class="flex items-center justify-between mt-4">
          ...
          <a
            class="
              ...
              hover:underline
            "
            ><NuxtLink to="/login">To Sign Up Please Login</NuxtLink></a
          >
  ...
  methods: {
    ...
    async login() {
      ...
      try {
        ...
        this.error = 'Logging You In In 2 Seconds'
        setTimeout(() => 
        this.alertOpen = true,
